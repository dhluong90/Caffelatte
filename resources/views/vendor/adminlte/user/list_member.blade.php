                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form action="{{ url('/admincp/user/member') }}" method="GET"
                                              class="form-list-filter-user">
                                        ...
                                        <table id="example2"
                                            ...
                                            @foreach ($users as $member)
                                                ...
                                                <tr role="row" class="{{ $i % 2 == 0 ? 'odd' : 'even' }}">
                                                    <td class="sorting_1">
                                                        <img src="{{ json_decode($member->image)[0] }}" alt=""
                                                             class="img-responsive" width="50px" height="50px">
                                                    </td>
                                                    <td class="sorting_1"><a
                                                                href="{{ url('/admincp/user/member/'.$member->id) }}">{{ $member->name }}</a>
                                                    </td>
                                                    <td class="sorting_1">{{ $member->age }}</td>
                                                    <td class="sorting_1">{{ $member->email }}</td>
                                                    <td class="sorting_1">{{ $member->gender == 1 ? 'Male' : 'Female' }}</td>
