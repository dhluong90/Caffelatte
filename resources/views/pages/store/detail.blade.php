            ...
            <div class="row">
                ...
                <div class="col-md-3  col-sm-3 col-xs-12 banner-right br">
                    <div class="banner-vote-point clearfix">
                        <div class="point-42">{{ number_format($store->_rate, 1, ',', '') }}</div>
                        <div class="vote-from">Bình chọn từ {{ $store->_comment }}
                    ...
                    <ul class="list-vote ">
                        <li>
                            <div class="left">
                                ...
                                <span class="icon-vote"><span class="fa fa-comments"></span></span>
                            </div>                                
                            <div class=" btn-more">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <div class="thumbnail ">
                        ...
                        <div class="caption ">
                            ...
                            <div class="left ">
                                <i class="fa {{ ($item_food->_rate > 0) ? (($item_food->_rate > 0.5) ? 'fa-star': 'fa-star-half-o') : 'fa-star-o' }} fa-lg star " aria-hidden="true "></i>
                                <i class="fa {{ ($item_food->_rate > 1) ? (($item_food->_rate > 1.5) ? 'fa-star': 'fa-star-half-o') : 'fa-star-o' }} fa-lg star " aria-hidden="true "></i>
                                <i class="fa {{ ($item_food->_rate > 2) ? (($item_food->_rate > 2.5) ? 'fa-star': 'fa-star-half-o') : 'fa-star-o' }} fa-lg star " aria-hidden="true "></i>
                                <i class="fa {{ ($item_food->_rate > 3) ? (($item_food->_rate > 3.5) ? 'fa-star': 'fa-star-half-o') : 'fa-star-o' }} fa-lg star " aria-hidden="true "></i>
                                <i class="fa {{ ($item_food->_rate > 4) ? (($item_food->_rate > 4.5) ? 'fa-star': 'fa-star-half-o') : 'fa-star-o' }} fa-lg star " aria-hidden="true "></i>
                                <span>&nbsp;{{ $item_food->_comment }}</span>
                            </div>
        ...
        <div class="row feedback">
                    ...
                    <div class="col-md-4 col-sm-4 ">
                        <div class="feedback-wp ">
                            ...
                            <div class="feedback-footer ">
                                ...
                                <a href="#" title="" class="more-link"  data-toggle="modal" data-target="#list-comment-modal" data-id="{{ $i }}">Xem chi tiết</a>
                           </div>
                           <div class="space "></div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 ">
                <div class="vote-table ">
                    ...
                    <div class="feedback-rank-point ">{{ number_format($store->_rate, 1, ',', '') }}</div>
                          ...
                          <li>
                              <div class="left">
                                  ...
                                  <div class=" right progessbar ">
                                      <div id="quality" style="width: {{ ($store->_rate / 5)*100 }}%"></div>
                                  </div>
                              </div>
                              <div class="right star-point">
                                  <span class="feedback-point">{{ number_format($store->_rate, 1, ',', '') }}</span>
                                  <i class="fa fa-star fa-lg star " aria-hidden="true "></i>
                              </div>
                          </li>
                          <li>
              ...
              <div class="vote-table2 ">
                  ...
                  <div class="feedback-content ">
                      <ul class="list-unstyled feedback-rating clearfix">
                        ...
                        @include('pages.partials.shared.modal_comment', ['item' => $store])
                  </div>
              </div>
            </div>
            <!-- end vote-table -->
